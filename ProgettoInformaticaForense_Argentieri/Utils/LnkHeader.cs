...
namespace ProgettoInformaticaForense_Argentieri.Utility
{
    public class LnkHeader
    {
        ...
        public enum DataFlag
        {
            ...
            [Description("A 16-bit target application is run in a separate virtual machine.")]
            ...
            [Description("The LNK does not contain a distributed link tracking data block")]
            ForceNoLinkTrack =
                0x00040000,
        ...
        public enum FileAttribute
        {
            ...
            [Description("Is offline. The data of the file is stored on an offline storage.")]
        ...
        public LnkHeader(byte[] rawBytes)
        {
